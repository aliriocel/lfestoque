    ...
    <div class="panel panel-default">
      <div class="panel-heading clearfix">
        <strong>
         ...
         <a href="add_user.php" class="btn btn-info pull-right">Add Novo Usuário</a>
      </div>
      ...
      <table class="table table-bordered table-striped">
        <thead>
          <tr>
            ...
            <th>Nome </th>
            <th>Login</th>
            <th class="text-center" style="width: 15%;">Nível</th>
          ...
          <?php endif;?>
           ...
           <td class="text-center">
             <div class="btn-group">
                ...
                <a href="delete_user.php?id=<?php echo (int)$a_user['id'];?>" class="btn btn-xs btn-danger" data-toggle="tooltip" title="Remover">
